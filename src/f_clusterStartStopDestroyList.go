...
func (c *config) clusterStartStopDestroy(DeployOn string, RemoteHost string, AccessPublicKeyFilePath string, ClusterName string, Nodes string, command string) (err error, ret int64) {
	// get backend
...
func (c *config) F_clusterStart() (err error, ret int64) {
...
func (c *config) F_clusterStop() (err error, ret int64) {
...
func (c *config) F_clusterDestroy() (err error, ret int64) {
...
func (c *config) F_clusterList() (err error, ret int64) {
	// get backend
