...
type ClusterAddCmd struct {
	...
	AgiClient ClusterAddAgiClientCmd `command:"agi-client" subcommands-optional:"true" description:"Install AGI live log dispatcher on cluster nodes" webicon:"fas fa-satellite-dish"`
