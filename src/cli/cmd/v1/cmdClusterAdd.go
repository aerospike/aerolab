...
type ClusterAddCmd struct {
	...
	AgiClient ClusterAddAgiClientCmd `command:"agi-client" subcommands-optional:"true" description:"Install AGI live log dispatcher in a cluster" webicon:"fas fa-stream"`
