...
type ClusterAddCmd struct {
	...
	AgiClient ClusterAddAgiClientCmd `command:"agi-client" subcommands-optional:"true" description:"Install AGI live log streaming dispatcher on a cluster" webicon:"fas fa-broadcast-tower"`
