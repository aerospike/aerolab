...
type xdrCreateClustersCmd struct {
	DestinationClusterNames string `short:"N" long:"destinations" description:"Comma-separate list of destination cluster names" default:"destdc"`
...
func (c *xdrCreateClustersCmd) Execute(args []string) error {
	...
	dst := strings.Split(c.DestinationClusterNames, ",")
