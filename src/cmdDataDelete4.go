...
func (c *dataDeleteCmd) delete4(args []string) error {
	_ = args
...
func (c *dataDeleteCmd) delete4do(i int, client *aerospike.Client, wp *aerospike.WritePolicy) error {
