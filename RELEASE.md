...
[Follow this manual for upgrade instructions](https://github.com/aerospike/aerolab/blob/v7.2.2/docs/upgrade-to-610.md)
...
See [the documentation](https://github.com/aerospike/aerolab/blob/v7.2.2/README.md) for full installation and usage instructions.

[Changelog](https://github.com/aerospike/aerolab/blob/v7.2.2/CHANGELOG.md#7.2.2)
