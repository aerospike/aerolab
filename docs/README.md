...
Aerolab is distributed as pre-built binaries for Linux, macOS, and Windows. Download the latest release from the [GitHub Releases page](https://github.com/citrusleaf/aerolab/releases).
