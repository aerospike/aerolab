...
import (
	...
	"github.com/aerospike-community/aerolab/pkg/utils/slack"
...
func (h *HTTPSNotify) notify(data []byte) error {
	...
	if (h.AbortOnFail && resp.StatusCode < 200 || resp.StatusCode > 299) || slices.Contains(h.AbortOnCode, resp.StatusCode) {
