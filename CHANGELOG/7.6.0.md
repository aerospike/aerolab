...
* WebUI: Passwords in "Command Line" show and history should be obfuscated with '****' (ensure agi asftp/s3 passwords are of type Password and obfuscated too, along any other password fields).
