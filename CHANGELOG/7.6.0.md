...
* Simple mode: Form fields should be hidden, not removed; fields that are disabled in simple mode cannot be modified (server-side check and error).
* Simple mode: form fields don't have simple mode yet, just command list.
