...
* Open ports 8998 and 8182 for Vector and Graph clients.

* TODO: `aerolab upgrade --edge` always get all pre-releases, sort by version and install latest; also provide `aerolab upgrade --fixes` which will upgrade to latest fix version, not latest test version.
* TODO: in GCP for the n4 family of instance types - https://cloud.google.com/compute/docs/general-purpose-machines#supported_disk_types_for_n4 does not support any other disk type than hyperdisk-balanced
